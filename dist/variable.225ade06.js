...
var globalName = 'global name'; //글로벌 스콥 -> 메모리에 할당 되어 있어서 최소한
...
var dayInWeek = 7;
var maxNumber = 5; // 변경 될 수 있는 것을 Mutable 이라고 한다.
// 4. Variable types
...
var helloBob = "hi ".concat(brendan, "!"); //template literals (string) 백틱으로 감싼 문자열 ${} 로 변수를 넣을 수 있다.
// boolean
...
var nothing = null;
console.log("value: ".concat(nothing, ", type: ").concat(_typeof(nothing))); // undefined 값을 할당하지 않은 것

var x; // 혹은 let x = undefined;

console.log("value: ".concat(x, ", type: ").concat(_typeof(x))); // symbol, create unique identifiers for objects -> 고유한 식별자
